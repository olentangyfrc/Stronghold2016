    ...
    public autonomousCommandGroup() {
        ...
        switch (lane) {
            case 1:
                ...
                this.addSequential(new DriveAuto(0.0, 0.0)); //1.2066 seconds for 10 ft. for Small Wheels
                //Drives forward for an inputed speed and time
                this.addSequential(new TurnAuto(0.0, 1, 0.0));//Turns right for an inputted speed and time
                this.addSequential(new ShooterWheelsMove(0.5)); //input speed for how fast the wheels spin
            ...
            case 2:
                ...
                this.addSequential(new DriveAuto(0.0, 0.0)); //1.2066 seconds for 10 ft. for Small Wheels
                this.addSequential(new TurnAuto(0.0, 1, 0.0));
                this.addSequential(new ShooterWheelsMove(0.5));
            ...
            case 4:
                lane = 4;
                this.addSequential(new DriveAuto(0.0, 0.0)); //1.2066 seconds for 10 ft. for Small Wheels
                this.addSequential(new TurnAuto(0.0, -1, 0.0)); //turns left
                this.addSequential(new ShooterWheelsMove(0.5));
                //addSequential (new AutoShooterSpinUp(0.5,5));
                //addParallel (new AutoShooterSol(1));
                break;
            ...
            case 6: //SpyBot Case
                ...
                this.addSequential(new TurnAuto(0.0, 1, 0.0));
                this.addSequential(new DriveAuto(0.0, 0.0)); // DriveAuto's have different length parameters
                break;
        }
